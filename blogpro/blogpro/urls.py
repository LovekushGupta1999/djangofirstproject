...
urlpatterns = [
    ...
    path('fn1/<int:pk>', views.fn1, name='fn1'),
    path('fn2/<int:pk>', views.fn2, name='fn2'),
    path('fn3/<int:pk>', views.fn3, name='fn3'),
    path('fn4/<int:pk>', views.fn4, name='fn4'),
    path('fn5/<int:pk>', views.fn5, name='fn5'),
